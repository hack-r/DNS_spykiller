...
- On Linux, the script currently supports NetworkManager-managed connections through `nmcli`, updates the saved connection profile, and then reapplies the active device or connection.
